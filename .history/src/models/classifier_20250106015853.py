...
class SleepStageClassifier:
    ...
    """
    def __init__(self, n_channels=7, class_weights=None):
        self.n_channels = n_channels
        self.class_weights = class_weights or [1.0, 2.0, 1.0, 1.5, 1.5]  # Default weights
    ...
    def _build_model(self):
        ...
        model.compile(
            optimizer=optimizer,
            loss=weighted_categorical_crossentropy(self.class_weights),
            metrics=['accuracy']
        )
...
def weighted_categorical_crossentropy(class_weights):
    """
    Create a weighted version of categorical crossentropy.
    Args:
