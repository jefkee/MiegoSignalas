...
class SleepDataset:
    ...
    def _get_hypnogram_file(self, psg_file):
        ...
        # Try different possible hypnogram patterns
        patterns = [
            '-Hypnogram.edf',  # Standard pattern
            'C-Hypnogram.edf', # Pattern with C
            'H-Hypnogram.edf', # Pattern with H
            'EH-Hypnogram.edf', # Pattern with EH
            'EC-Hypnogram.edf', # Pattern with EC
            '.Hypnogram.edf',
            '-HYP.edf',
            '.HYP.edf',
            '_HYP.edf',
        ...
        base_variants = [
            ...
            base_name + 'C',              # Append C
            base_name + 'H'               # Append H
        ]
